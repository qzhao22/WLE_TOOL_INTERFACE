<!-- This page lists all basins available.
     This page is redirected by choosing the scenario mode.     
 -->
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class='col-md-4'>
<h2><a href = 'RunSModelByWLETOOL.php?Basin=Mekong&w=<?php echo $_GET['w'];?>&h=<?php echo $_GET['h'];?>'>The Mekong Basin</a>
</h2></div>